...
public class Physics
{
     ...
     * @param accValue acceleration value - PPS
     * @param maxSpeed maximum speed - PPS
     * @param decValue deceleration value - PPS
     */
    ...
    {
        // apply acceleration
        velocity.addToCoordinates(
                acceleration.x * dt,
                acceleration.y * dt);

        double speed = getSpeed(); //velocity.getLength();
